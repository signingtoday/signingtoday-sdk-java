...
public class Bit4idPathgroupSignatureTransactionsApi {
     ...
     */
    public okhttp3.Call cancelDSTCall(String organizationId, Id dstId, InlineObject1 inlineObject1, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call cancelDSTValidateBeforeCall(String organizationId, Id dstId, InlineObject1 inlineObject1, final ApiCallback _callback) throws ApiException {
        ...
        if (inlineObject1 == null) {
            throw new ApiException("Missing the required parameter 'inlineObject1' when calling cancelDST(Async)");
        }
        

        okhttp3.Call localVarCall = cancelDSTCall(organizationId, dstId, inlineObject1, _callback);
        return localVarCall;
     ...
     */
    public InlineResponse2013 cancelDST(String organizationId, Id dstId, InlineObject1 inlineObject1) throws ApiException {
        ApiResponse<InlineResponse2013> localVarResp = cancelDSTWithHttpInfo(organizationId, dstId, inlineObject1);
     ...
     */
    public ApiResponse<InlineResponse2013> cancelDSTWithHttpInfo(String organizationId, Id dstId, InlineObject1 inlineObject1) throws ApiException {
        okhttp3.Call localVarCall = cancelDSTValidateBeforeCall(organizationId, dstId, inlineObject1, null);
     ...
     */
    public okhttp3.Call cancelDSTAsync(String organizationId, Id dstId, InlineObject1 inlineObject1, final ApiCallback<InlineResponse2013> _callback) throws ApiException {

        okhttp3.Call localVarCall = cancelDSTValidateBeforeCall(organizationId, dstId, inlineObject1, _callback);
        Type localVarReturnType = new TypeToken<InlineResponse2013>(){}.getType();
     ...
     */
    public InlineResponse2007 deleteDST(String organizationId, Id dstId) throws ApiException {
        ApiResponse<InlineResponse2007> localVarResp = deleteDSTWithHttpInfo(organizationId, dstId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<InlineResponse2007> deleteDSTWithHttpInfo(String organizationId, Id dstId) throws ApiException {
     ...
     */
    public okhttp3.Call deleteDSTAsync(String organizationId, Id dstId, final ApiCallback<InlineResponse2007> _callback) throws ApiException {
    ...
    private okhttp3.Call listDSTsValidateBeforeCall(String organizationId, String whereSigner, String whereStatus, String whereTitle, String whereCreatedBy, String whereCreated, String whereSignatureStatus, String whereDocumentName, String whereReason, String whereSignatureName, String whereSignerGroup, Integer page, Integer count, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listDSTsCall(organizationId, whereSigner, whereStatus, whereTitle, whereCreatedBy, whereCreated, whereSignatureStatus, whereDocumentName, whereReason, whereSignatureName, whereSignerGroup, page, count, _callback);
        return localVarCall;
     ...
     */
    public InlineResponse2006 listDSTs(String organizationId, String whereSigner, String whereStatus, String whereTitle, String whereCreatedBy, String whereCreated, String whereSignatureStatus, String whereDocumentName, String whereReason, String whereSignatureName, String whereSignerGroup, Integer page, Integer count) throws ApiException {
        ApiResponse<InlineResponse2006> localVarResp = listDSTsWithHttpInfo(organizationId, whereSigner, whereStatus, whereTitle, whereCreatedBy, whereCreated, whereSignatureStatus, whereDocumentName, whereReason, whereSignatureName, whereSignerGroup, page, count);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<InlineResponse2006> listDSTsWithHttpInfo(String organizationId, String whereSigner, String whereStatus, String whereTitle, String whereCreatedBy, String whereCreated, String whereSignatureStatus, String whereDocumentName, String whereReason, String whereSignatureName, String whereSignerGroup, Integer page, Integer count) throws ApiException {
        okhttp3.Call localVarCall = listDSTsValidateBeforeCall(organizationId, whereSigner, whereStatus, whereTitle, whereCreatedBy, whereCreated, whereSignatureStatus, whereDocumentName, whereReason, whereSignatureName, whereSignerGroup, page, count, null);
     ...
     */
    public okhttp3.Call listDSTsAsync(String organizationId, String whereSigner, String whereStatus, String whereTitle, String whereCreatedBy, String whereCreated, String whereSignatureStatus, String whereDocumentName, String whereReason, String whereSignatureName, String whereSignerGroup, Integer page, Integer count, final ApiCallback<InlineResponse2006> _callback) throws ApiException {

        okhttp3.Call localVarCall = listDSTsValidateBeforeCall(organizationId, whereSigner, whereStatus, whereTitle, whereCreatedBy, whereCreated, whereSignatureStatus, whereDocumentName, whereReason, whereSignatureName, whereSignerGroup, page, count, _callback);
        Type localVarReturnType = new TypeToken<InlineResponse2006>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
