...
import signingToday.client.model.SMS;
...
public class IdentityRequest {
  ...
  public IdentityRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(example = "string label", value = "The label is an arbitrary name is possible to associate to an idenity. Doing so allows to distinguish different identities issued from the same provider during the performance of the signature in the signature tray")
  ...
  public IdentityRequest providerData(SMS providerData) {
  ...
  **/
  ...
  public SMS getProviderData() {
    return providerData;
  }

  public void setProviderData(SMS providerData) {
    this.providerData = providerData;
  }

  public IdentityRequest providerId(ProviderIdEnum providerId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "sms", value = "The id of the provider will issue the requested identity")
  ...
  public IdentityRequest registeredBy(String registeredBy) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "jdo", value = "The RAO user that registered the identity")
  ...
  public IdentityRequest user(String user) {
    this.user = user;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "jdo", value = "The user is intended to associate the requestd identity")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.label, identityRequest.label) &&
        Objects.equals(this.providerData, identityRequest.providerData) &&
        Objects.equals(this.providerId, identityRequest.providerId) &&
        Objects.equals(this.registeredBy, identityRequest.registeredBy) &&
        Objects.equals(this.user, identityRequest.user);
  }

  @Override
  public int hashCode() {
    return Objects.hash(label, providerData, providerId, registeredBy, user);
  }
