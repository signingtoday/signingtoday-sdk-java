...
public class SignatureWhere {
  ...
  public SignatureWhere page(Integer page) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1", value = "As can be guessed this is the page where to allocate the Signature")
  ...
  public SignatureWhere position(String position) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "rect: 50, 100, 200, 150", value = "This is the exact position in the choosen page where to attach the Signature. Multiple unit of measurement are provided. The format is the following: \"rect: 50mm, 100mm, 200mm, 150mm\" ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SignatureWhere signatureWhere = (SignatureWhere) o;
    return Objects.equals(this.page, signatureWhere.page) &&
        Objects.equals(this.position, signatureWhere.position);
  }
