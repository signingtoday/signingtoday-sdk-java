...
import signingToday.client.model.SignatureDST;
...
public class Document1 {
  ...
  private List<List<SignatureDST>> groups = null;


  public Document1 displayName(String displayName) {
  ...
  **/
  ...
  public Document1 documentUri(String documentUri) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "http://www.africau.edu/images/default/sample.pdf", value = "This is the url from where the document, commonly in pdf format, has been uploaded to the Digital Signature Transaction")
  ...
  public Document1 groups(List<List<SignatureDST>> groups) {
    
    this.groups = groups;
    return this;
  }

  public Document1 addGroupsItem(List<SignatureDST> groupsItem) {
    if (this.groups == null) {
      this.groups = new ArrayList<List<SignatureDST>>();
    }
  ...
  **/
  ...
  public List<List<SignatureDST>> getGroups() {
    return groups;
  }


  public void setGroups(List<List<SignatureDST>> groups) {
    this.groups = groups;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.displayName, document1.displayName) &&
        Objects.equals(this.documentUri, document1.documentUri) &&
        Objects.equals(this.groups, document1.groups);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayName, documentUri, groups);
  }
