...
public class InlineResponse2005 {
  ...
  private List<IdentityEnroll> data = new ArrayList<IdentityEnroll>();
  ...
  public InlineResponse2005 data(List<IdentityEnroll> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2005 addDataItem(IdentityEnroll dataItem) {
    if (this.data == null) {
