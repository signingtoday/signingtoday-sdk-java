...
public class IdentityAssociation {
  ...
  public IdentityAssociation providerId(ProviderIdEnum providerId) {
  ...
  **/
  ...
  @ApiModelProperty(example = "aruba", value = "_provider_id_ is the univocal name of the provider that issued the identity ")
  ...
  public IdentityAssociation label(String label) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "aruba-prv", value = "The label is an arbitrary name is possible to associate to an idenity. Doing so allows to distinguish different identities issued from the same provider during the performance of the signature in the signature tray")
  ...
  public IdentityAssociation providerData(Object providerData) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IdentityAssociation identityAssociation = (IdentityAssociation) o;
    return Objects.equals(this.providerId, identityAssociation.providerId) &&
        Objects.equals(this.label, identityAssociation.label) &&
        Objects.equals(this.providerData, identityAssociation.providerData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(providerId, label, providerData);
  }
