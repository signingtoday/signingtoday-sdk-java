...
public class InlineResponse2006 {
  ...
  private List<SignatureTransaction> data = new ArrayList<SignatureTransaction>();

  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private MetaDataSuccess meta = null;

  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private PaginationData pagination = null;

  public InlineResponse2006 data(List<SignatureTransaction> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2006 addDataItem(SignatureTransaction dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public InlineResponse2006 pagination(PaginationData pagination) {
