...
public class IdentityEnroll {
  ...
  private IdentityEnrollActions actions = null;
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(actions, createdBy, enrollTicket, id, label, next, provider, providerData, providerType, registeredBy, status, urlback, user);
  }
