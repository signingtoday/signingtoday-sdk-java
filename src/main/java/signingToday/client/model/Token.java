...
import signingToday.client.model.CreateTokenHttpOptions;
import signingToday.client.model.CreateTokenWebhooks;
...
public class Token {
  ...
  private CreateTokenHttpOptions httpOptions = null;
  ...
  private CreateTokenWebhooks webhooks = null;
  ...
  **/
  ...
  @ApiModelProperty(example = "jdo@bit4id", value = "The user created the Token - _user_name@organization-id_ -")
  public String getCreatedBy() {
    return createdBy;
  }

  public Token httpOptions(CreateTokenHttpOptions httpOptions) {
  ...
  **/
  ...
  public CreateTokenHttpOptions getHttpOptions() {
    return httpOptions;
  }

  public void setHttpOptions(CreateTokenHttpOptions httpOptions) {
    this.httpOptions = httpOptions;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "737dc132-a3f0-11e9-a2a3-2a2ae2dbcce4", value = "The uuid code that identifies the Token")
  public UUID getId() {
    return id;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Signing Today Token", value = "The label assigned to the Token, that is like the name is associated to it")
  public String getLabel() {
    return label;
  }

  public Token user(String user) {
    this.user = user;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "jdo", value = "The user whom is associated the Token")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "8df173c3bcd4274715491fc196705da8", value = "This is the actual value of the Token, usually in a uuid format")
  public String getValue() {
    return value;
  }

  public Token webhooks(CreateTokenWebhooks webhooks) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")
  public CreateTokenWebhooks getWebhooks() {
    return webhooks;
  }

  public void setWebhooks(CreateTokenWebhooks webhooks) {
    this.webhooks = webhooks;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Token token = (Token) o;
    return Objects.equals(this.createdBy, token.createdBy) &&
        Objects.equals(this.httpOptions, token.httpOptions) &&
        Objects.equals(this.id, token.id) &&
        Objects.equals(this.label, token.label) &&
        Objects.equals(this.user, token.user) &&
        Objects.equals(this.value, token.value) &&
        Objects.equals(this.webhooks, token.webhooks);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdBy, httpOptions, id, label, user, value, webhooks);
  }
