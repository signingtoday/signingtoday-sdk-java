...
public class SignatureTransaction {
  ...
  private List<Document1> documents = new ArrayList<Document1>();
  ...
  **/
  ...
  public SignatureTransaction documents(List<Document1> documents) {
    this.documents = documents;
    return this;
  }

  public SignatureTransaction addDocumentsItem(Document1 documentsItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(created, createdBy, documents, id, notAfter, reason, status, templateName, title, urlback);
  }
