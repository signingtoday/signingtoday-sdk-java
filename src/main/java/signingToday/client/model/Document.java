...
public class Document {
  ...
  private List<List<SignatureDST>> groups = new ArrayList<List<SignatureDST>>();
  ...
  **/
  ...
  public Document groups(List<List<SignatureDST>> groups) {
    this.groups = groups;
    return this;
  }

  public Document addGroupsItem(List<SignatureDST> groupsItem) {
    if (this.groups == null) {
