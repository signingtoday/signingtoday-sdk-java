...
/**
 * API tests for Bit4idPathgroupSignaturesApi
 */
@Ignore
public class Bit4idPathgroupSignaturesApiTest {

    private final Bit4idPathgroupSignaturesApi api = new Bit4idPathgroupSignaturesApi();
    ...
    public void createChannelTest() throws ApiException {
        ...
        Id dstId = null;
        InlineResponse2014 response = api.createChannel(organizationId, dstId);
     ...
     */
    @Test
    public void declineDSTTest() throws ApiException {
        String organizationId = null;
        Id signatureId = null;
        InlineObject5 inlineObject5 = null;
        InlineResponse2013 response = api.declineDST(organizationId, signatureId, inlineObject5);
     ...
     */
    @Test
    public void performDSTTest() throws ApiException {
        String organizationId = null;
        Id signatureId = null;
        AutomaticSignature automaticSignature = null;
        InlineResponse20011 response = api.performDST(organizationId, signatureId, automaticSignature);
     ...
     */
    @Test
    public void performSignatureTest() throws ApiException {
        String organizationId = null;
        Id signatureId = null;
        Id identityId = null;
        InlineObject3 inlineObject3 = null;
        InlineResponse20012 response = api.performSignature(organizationId, signatureId, identityId, inlineObject3);
     ...
     */
    @Test
    public void performSignatureWithSessionTest() throws ApiException {
        String organizationId = null;
        Id signatureId = null;
        InlineObject4 inlineObject4 = null;
        InlineResponse20013 response = api.performSignatureWithSession(organizationId, signatureId, inlineObject4);
