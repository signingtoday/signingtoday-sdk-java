...
public class Bit4idPathgroupSignaturesApiTest {
    ...
    public void createChannelTest() throws ApiException {
        ...
        Id dstId = null;
        InlineResponse201 response = api.createChannel(organizationId, dstId);
    ...
    public void declineDSTTest() throws ApiException {
        ...
        InlineResponse2013 response = api.declineDST(organizationId, signatureId, inlineObject2);
    ...
    public void performDSTTest() throws ApiException {
        ...
        InlineResponse2008 response = api.performDST(organizationId, signatureId, automaticSignature);
    ...
    public void performSignatureTest() throws ApiException {
        ...
        InlineResponse2009 response = api.performSignature(organizationId, signatureId, identityId, inlineObject3);
    ...
    public void performSignatureWithSessionTest() throws ApiException {
        ...
        InlineResponse20010 response = api.performSignatureWithSession(organizationId, signatureId, inlineObject4);
