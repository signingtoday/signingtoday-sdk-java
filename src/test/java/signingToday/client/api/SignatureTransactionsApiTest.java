...
/**
 * API tests for SignatureTransactionsApi
 */
@Ignore
public class SignatureTransactionsApiTest {

    private final SignatureTransactionsApi api = new SignatureTransactionsApi();
    ...
    public void cancelDSTTest() throws ApiException {
        ...
        InlineResponse2013 response = api.cancelDST(organizationId, dstId, inlineObject1);
    ...
    public void deleteDSTTest() throws ApiException {
        String organizationId = null;
        Id dstId = null;
        InlineResponse2007 response = api.deleteDST(organizationId, dstId);
    ...
    public void listDSTsTest() throws ApiException {
        ...
        Integer page = null;
        Integer count = null;
        InlineResponse2006 response = api.listDSTs(organizationId, whereSigner, whereStatus, whereTitle, whereCreatedBy, whereCreated, whereSignatureStatus, whereDocumentName, whereReason, whereSignatureName, whereSignerGroup, page, count);
