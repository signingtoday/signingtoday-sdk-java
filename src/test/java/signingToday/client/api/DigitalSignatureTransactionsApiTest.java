...
/**
 * API tests for DigitalSignatureTransactionsApi
 */
@Ignore
public class DigitalSignatureTransactionsApiTest {

    private final DigitalSignatureTransactionsApi api = new DigitalSignatureTransactionsApi();
