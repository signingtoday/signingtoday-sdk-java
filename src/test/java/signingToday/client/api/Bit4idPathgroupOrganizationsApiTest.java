...
/**
 * API tests for Bit4idPathgroupOrganizationsApi
 */
@Ignore
public class Bit4idPathgroupOrganizationsApiTest {

    private final Bit4idPathgroupOrganizationsApi api = new Bit4idPathgroupOrganizationsApi();
    ...
    public void getOrganizationTest() throws ApiException {
        ...
        InlineResponse200 response = api.getOrganization(organizationId);
    ...
    public void patchOrganizationTest() throws ApiException {
        ...
        InlineResponse200 response = api.patchOrganization(organizationId, updateOrganization);
