...
public class Bit4idPathgroupTokensApiTest {
    ...
    public void createTokenTest() throws ApiException {
        ...
        InlineResponse2014 response = api.createToken(organizationId, createToken);
    ...
    public void getTokenTest() throws ApiException {
        String organizationId = null;
        Id tokenId = null;
        InlineResponse2014 response = api.getToken(organizationId, tokenId);
    ...
    public void listTokensTest() throws ApiException {
        ...
        Integer count = null;
        Integer page = null;
        InlineResponse20011 response = api.listTokens(organizationId, whereUser, whereLabel, count, page);
    ...
    public void listUserTokensTest() throws ApiException {
        ...
        Integer page = null;
        Integer count = null;
        InlineResponse20011 response = api.listUserTokens(organizationId, userId, page, count);
    ...
    public void updateTokenTest() throws ApiException {
        ...
        InlineResponse2014 response = api.updateToken(organizationId, tokenId, updateToken);
