...
/**
 * API tests for Bit4idPathgroupTokensApi
 */
@Ignore
public class Bit4idPathgroupTokensApiTest {

    private final Bit4idPathgroupTokensApi api = new Bit4idPathgroupTokensApi();
    ...
    public void createTokenTest() throws ApiException {
        ...
        InlineResponse2015 response = api.createToken(organizationId, createToken);
    ...
    public void deleteTokenTest() throws ApiException {
        String organizationId = null;
        Id tokenId = null;
        InlineResponse2012 response = api.deleteToken(organizationId, tokenId);
    ...
    public void getTokenTest() throws ApiException {
        String organizationId = null;
        Id tokenId = null;
        InlineResponse2015 response = api.getToken(organizationId, tokenId);
    ...
    public void listTokensTest() throws ApiException {
        ...
        InlineResponse2004 response = api.listTokens(organizationId, whereUser, whereLabel, count, page, whereOrder);
     ...
     */
    @Test
    public void listUserTokensTest() throws ApiException {
        String organizationId = null;
        Id userId = null;
        Integer page = null;
        Integer count = null;
        String whereOrder = null;
        InlineResponse2004 response = api.listUserTokens(organizationId, userId, page, count, whereOrder);
    ...
    public void updateTokenTest() throws ApiException {
        ...
        InlineResponse2015 response = api.updateToken(organizationId, tokenId, updateToken);
