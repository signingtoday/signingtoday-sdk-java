...
/**
 * API tests for Bit4idPathgroupResourcesApi
 */
@Ignore
public class Bit4idPathgroupResourcesApiTest {

    private final Bit4idPathgroupResourcesApi api = new Bit4idPathgroupResourcesApi();
