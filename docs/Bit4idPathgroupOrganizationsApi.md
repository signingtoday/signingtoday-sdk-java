...
import signingToday.client.api.Bit4idPathgroupOrganizationsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    Bit4idPathgroupOrganizationsApi apiInstance = new Bit4idPathgroupOrganizationsApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling Bit4idPathgroupOrganizationsApi#getOrganization");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling Bit4idPathgroupOrganizationsApi#patchOrganization");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
